...
export default class ImpactResearch extends Component {
        ...
        <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
                <ScrollView>
                    ...
                    <Text style={styles.completeArticleTitle}>{this.state.articleInfluence}</Text>
                    <Text style={styles.modalItensTitles}>{strings.eigenfactor}</Text>
                    <Text style={styles.completeArticleTitle}>{this.state.eigenfactor}</Text>
                    ...
                    <Text style={styles.completeArticleTitle}>{this.state.hindexfive}</Text>
    ...
    doResearch = async () => {
        ...
        for (let i = 0; i < this.state.firebasePapers.length; i++) {
            ...
            let articleTitleString = this.state.articles[i].Título.replace(/\s/g, "").toUpperCase().trim();
